            ...
            <>
              <View>
                <ButtonComponent
                  ...
                  color="whiteText"
                  background="primary"
                  action={() => router.push(`/stacks/messages?conversationId=1&propertyID=${propertyID}`)}
                />
              </View>
              <View>
                <ButtonComponent text="Save and Pay" color="whiteText" background="secondary" action={() => router.push('/tabs/payments')} />
              </View>
            </>
          )}
        </View>
